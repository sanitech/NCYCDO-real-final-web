  ...
  return (
    <div>
      <div class="container mx-auto">
        <main class="mt-12">
          <div class="grid grid-cols-1 sm:grid-cols-3 space-x-0 md:space-x-6 mb-16">
            <div class="mb-4 lg:mb-0 col-span-2 p-4 lg:p-0  md:w-4/7 relative rounded block">
              <img
              ...
              <a
                href="#"
                class="inline-block px-6 py-3 mt-2 rounded-md bg-amber-500 text-gray-100"
              >
                Read more
              </a>
            </div>

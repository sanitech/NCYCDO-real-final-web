                ...
                <div class="lg:max-w-lg lg:mx-auto lg:me-0 ms-auto">
                  <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-slate-900">
                    <div class="text-start">
                      ...
                      To scan a QR code, you need to have one of the following things: A barcode reader that has the capability to scan QR codes. Tablet or a smartphone with an inbuilt camera.
                        
                      </p>
                    </div>

                    <div class="mt-5">
                    <img className="h-56 w-56 mx-auto" src="https://www.qr-code-generator.com/wp-content/themes/qr/images/banners/frames/websiteQRCode_noFrame.png" alt="" />

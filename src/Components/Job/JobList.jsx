...
function JobList() {
  return (
    <div>
      <div class="relative flex flex-col jus items-center justify-center overflow-hidden bg-gray-50 p-6 sm:py-12 dark:bg-gray-800">
        <div class="bg-white  shadow-xl shadow-gray-100 dark:shadow-gray-500 dark:bg-gray-100 w-full max-w-4xl flex flex-col sm:flex-row gap-3 sm:items-center  justify-between px-5 py-4 rounded-md">
          <div>

...
import { adviseryBord } from "../../Data/Data";

function OurAdvisory() {
  return (
    <div>
              ...
              <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 dark:bg-slate-900 dark:border-gray-700">
                <div class="flex items-center gap-x-4">
                  ...
                  <div class="grow">
                    ...
                    <p class="text-xs uppercase text-gray-500">{adviseryBord.position}</p>
                  </div>
                </div>

          ...
          <div className="col-span-1 py-14">
            ...
            <div className="mt-8">
              <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">
                ...
                <div className="text-base font-normal dark:text-gray-400">By submitting your membership application, you acknowledge that you have read, understood, and agreed to abide by these membership terms and conditions</div>

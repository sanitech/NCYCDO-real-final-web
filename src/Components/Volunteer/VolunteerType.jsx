      ...
      <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-12 mx-auto">
        <div class="grid sm:grid-cols-2 md:grid-cols-2 gap-3 sm:gap-6">
          <Link
            ...
            class="hs-tab-active:bg-amber-500 hs-tab-active:shadow-md hs-tab-active:hover:border-transparent group flex flex-col border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
            href="#"
          >
            ...
            <div class="p-4 md:p-5">
              <div class="flex justify-center items-center">
                <div>
                  ...
                  <h3 class="group-hover:text-gray-400 font-semibold text-gray-800 dark:group-hover:text-gray-400 dark:text-gray-200">
                    Group
                  </h3>
                </div>
              </div>
